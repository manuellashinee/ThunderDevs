    ...
    <section className='container'>
      ...
      <div className='quadro'>
       ...
       <div className='harry'>
        ...
        <div className='descricao'><p>FAÇA SEU LOGIN PARA TER
           ACESSO AO NOSSO CATÁLOGO IMPERDÍVEL, NOSSO PLANO CINEMA, BONÛS E OFERTAS UNICOS!</p></div>
       </div>
       ...
       <div className='botoes'>
        ...
        <div className='b2'><button className='segundo'>CADASTRE-SE</button></div>
       </div>
